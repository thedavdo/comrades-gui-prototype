...
////////////////////////////////////////////////////////////////
    ...
    public void startGame() {
    	switch (gameMode)
    	{
        case 1:  BOARD_PANEL.White = "Human Player";
        		 BOARD_PANEL.Black = INSTANCES[0].name;
                 break;
        case 2:  BOARD_PANEL.White = INSTANCES[0].name;
        		 BOARD_PANEL.Black = INSTANCES[0].name;
        		 break;
        case 3:  BOARD_PANEL.White = INSTANCES[0].name;
        		 BOARD_PANEL.Black = INSTANCES[0].name;
        		 break;
        default: BOARD_PANEL.White = "Human Player";
        		 BOARD_PANEL.Black = INSTANCES[0].name;
        		 break;
    	}
